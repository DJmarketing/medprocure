              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  {product.uom && (
                    <>
                      <div className="grid grid-cols-2 gap-2 py-1">
                        ...
                        <div className="text-sm">{product.uom}</div>
                      </div>
                      <Separator />
                    </>
                  )}
                  {product.uomQuantity && (
                    <>
                      <div className="grid grid-cols-2 gap-2 py-1">
                        <div className="text-sm font-medium">UOM Quantity</div>
                        <div className="text-sm">{product.uomQuantity}</div>
                      </div>
                      <Separator />
                    </>
                  )}
